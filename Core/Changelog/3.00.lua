...
W.Changelog[300] = {
    ...
    IMPORTANT = {
        ["zhCN"] = {
            "坚决抵制插件付费行为! 更新授权以对插件分发进行限制, 今后请勿在任何非授权渠道分发本插件.",
            "授权渠道现在仅为 CurseForge, Wago, WoWInterface, 以及 178 魔兽插件站. 详见 LICENSE 文件.",
            "最低支持的 ElvUI 版本变更为 13.00.",
            "按钮修复现在可以自动进行."
        },
        ["zhTW"] = {
            "堅決抵制插件付費行為! 更新授權以對插件分發進行限制, 今後請勿在任何非授權渠道分發本插件.",
            "授權渠道現在僅為 CurseForge, Wago, WoWInterface, 以及 178 魔獸插件站. 詳見 LICENSE 文件.",
            "最低支援的 ElvUI 版本變更為 13.00.",
            "按鈕修復現在可以自動進行."
        },
        ["enUS"] = {
            "Resolutely resist the payment behavior of addons! Update license to restrict the distribution of the addon, please do not distribute this addon in any unauthorized channel in the future.",
