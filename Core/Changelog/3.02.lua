...
W.Changelog[302] = {
    ...
    IMPROVEMENT = {
        ...
        ["enUS"] = {
            "[Already Known] Fixed an error that may occur in the guild bank.",
            "[Misc] Cleaned up some debug codes.",
            "[Minimap Buttons] Fixed the expansion landing page button scaling error when not using ElvUI minimap.",
            ...
            "[Skins] Fixed and optimized the Premade Groups Filter skin."
        },
        ["koKR"] = {
            "[Already Known] Fixed an error that may occur in the guild bank.",
            "[Misc] Cleaned up some debug codes.",
