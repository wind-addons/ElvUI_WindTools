...
W.Changelog[327] = {
    ...
    IMPROVEMENT = {
        ...
        ["ruRU"] = {
            ...
            "[Текст чата] Сообщение о состоянии члена гильдии теперь следует настройкам системного канала.",
            "[Текст чата] Сообщение о слиянии достижений теперь следует настройкам системного канала."
        }
    }
}
