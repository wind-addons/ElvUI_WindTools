...
W.Changelog[372] = {
	...
	IMPROVEMENT = {
		...
		["enUS"] = {
			...
			"[Extra Item Bar] Added more items that can be enabled. Thanks to mcc",
			"[Extra Item Bar] Completed the cooking items for TWW.",
			"[World Map] Fixed a bug that may cause Blizzard map errors.",
			"[Minimap Buttons] Optimized the processing logic of some icons.",
		},
		["koKR"] = {
