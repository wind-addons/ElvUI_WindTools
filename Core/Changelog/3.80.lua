...
W.Changelog[380] = {
	...
	IMPORTANT = {
		...
		["ruRU"] = {
			"Обновлен LibOpenRaid до последней версии.",
	...
	NEW = {
		...
		["ruRU"] = {
			"[Подсказка] Добавлена новая информация о камнях ключей, но для использования этой функции требуется установка WindTools или Details! на целевом персонаже.",
		},
	},
	IMPROVEMENT = {
		["zhCN"] = {
		...
		["ruRU"] = {
			...
			"[Игровая панель] Если направление якоря подсказки установлено вверх, то системное сообщение также будет отображаться вверху.",
