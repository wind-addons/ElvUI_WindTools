...
W.Changelog[397] = {
	...
	IMPROVEMENT = {
		...
		["enUS"] = {
			...
			"[Extra Item Bar] Some delve items will not be displayed outdoors.",
		},
		["koKR"] = {
		...
		["ruRU"] = {
			...
			"[ДПанель дополнительных предметов] Некоторые предметы исследования не будут отображаться на улице.",
		},
	},
}
