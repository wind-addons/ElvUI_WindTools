...
W.Changelog[398] = {
	...
	NEW = {
		...
		["ruRU"] = {
			"[События] Добавлено событие 'Сумерки'.",
			"[События] Добавлено еженедельное событие 'Экологическая сукцессия'.",
			"[События] Добавлена кнопка быстрого доступа на правой панели.",
			"[События] Добавлена функция замены цвета шрифта для рамки ошибок UI.",
		},
	},
	IMPROVEMENT = {
		["zhCN"] = {
