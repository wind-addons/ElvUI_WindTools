...
W.Changelog[398] = {
	...
	NEW = {
		...
		["ruRU"] = {
			'[Отслеживание событий] Добавлено событие "Ночной бой".',
			'[Отслеживание событий] Добавлено еженедельное событие "Экологическая смена".',
			"[Список LFG] Добавлена кнопка быстрого доступа на правой панели.",
			"[Скины] Добавлена функция замены цвета шрифта для окна ошибок интерфейса.",
