...
W.Changelog[399] = {
	...
	IMPROVEMENT = {
		...
		["enUS"] = {
			...
			"[Skins] Optimize WeakAuras option skin.",
		...
		["ruRU"] = {
			...
			"[Скины] Оптимизирован внешний вид опций WeakAuras.",
