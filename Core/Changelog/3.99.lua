...
W.Changelog[399] = {
	...
	IMPROVEMENT = {
		...
		["ruRU"] = {
			...
			"[Расширить страницы торговца] Теперь автоматически отключается при использовании с другими известными похожими аддонами.",
			"[Расширить страницы торговца] Оптимизировано положение кнопки выкупа.",
