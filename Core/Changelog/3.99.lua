...
W.Changelog[399] = {
	...
	NEW = {
		...
		["ruRU"] = {
			...
			"[LFG список] Добавлена кнопка в интерфейс ключа группы (по умолчанию на третьей вкладке внизу списка LFG), которая позволяет отправить информацию о ключе текущей группы в чат партии одним щелчком.",
			"[Подсказка] Добавлена опция для автоматической очистки стандартной групповой информации Blizzard при использовании функции групповой информации в панели инструментов, включена по умолчанию.",
		},
	},
	IMPROVEMENT = {
		["zhCN"] = {
