...
W.Changelog[401] = {
	...
	IMPROVEMENT = {
		["zhCN"] = {
			...
			"[小地图按钮] 增强了对部分按钮的支持.",
			"[战斗提示] 重构了模块, 提升性能.",
			"[鼠标提示] - [进度] 新增了军团 Remix 的史诗钥石地下城支持.",
			"[鼠标提示] - [钥石] 新增了军团 Remix 的史诗钥石地下城支持.",
		...
		["zhTW"] = {
			...
			"[小地圖按鈕] 增強了對部分按鈕的支援.",
			"[戰鬥提示] 重構了模組, 提升效能.",
			"[浮動提示] - [進度] 新增了軍團 Remix 的史詩鑰石地城支援.",
			"[浮動提示] - [鑰石] 新增了軍團 Remix 的史詩鑰石地城支援.",
		...
		["enUS"] = {
			...
			"[Tooltips] - [Progression] Add support for Legion Remix Mythic+ dungeons.",
			"[Tooltips] - [Keystone] Add support for Legion Remix Mythic+ dungeons.",
		...
		["koKR"] = {
			...
			"[툴팁] - [진행 상황] 군단 리믹스 신화+ 던전에 대한 지원이 추가되었습니다.",
			"[툴팁] - [열쇠돌] 군단 리믹스 신화+ 던전에 대한 지원이 추가되었습니다.",
		...
		["ruRU"] = {
			...
			"[Подсказки] - [Прогресс] Добавлена поддержка подземелий Легиона Remix Mythic+.",
			"[Подсказки] - [Ключ] Добавлена поддержка подземелий Легиона Remix Mythic+.",
