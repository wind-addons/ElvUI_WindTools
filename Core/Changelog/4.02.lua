...
W.Changelog[402] = {
	...
	IMPROVEMENT = {
		...
		["ruRU"] = {
			...
			"[Интерфейс] Оптимизирован фоновый эффект скина Rematch. Спасибо gizzmo",
			"[Интерфейс] Улучшена стабильность стилизации страницы коллекций Legion Remix Helper.",
			"[Интерфейс] Оптимизирован скин Auctionator.",
