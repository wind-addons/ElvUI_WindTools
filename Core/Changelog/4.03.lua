...
W.Changelog[403] = {
	...
	IMPROVEMENT = {
		["zhCN"] = {
			...
			"[其他] - [自动截图] 修复了重构版本的战斗提示无法在截图时自动隐藏的问题.",
			"[其他] - [自动截图] 优化了逻辑, 在多个成就同时获得时, 只会截图一次.",
		},
		["zhTW"] = {
			"[美化皮膚] 優化了社區視窗的皮膚.",
			"[美化皮膚] 優化了獲得物品時提示的皮膚.",
			...
			"[通告] - [實用技能] 新增了對軍團幻彩版本中召喚捲軸的通告支援.",
			"[其他] - [自動擷圖] 修復了重構版本的戰鬥提示無法在擷圖時自動隱藏的問題.",
			"[其他] - [自動擷圖] 優化了邏輯, 在多個成就同時獲得時, 只會擷圖一次.",
		},
		["enUS"] = {
			...
			"[Announcement] - [Utilities] Added announcement support for Summoning Scrolls from the Legion Remix.",
			"[Misc] - [Auto Screenshot] Fixed an issue where the combat alert could not be automatically hidden when taking screenshots in the refactored version.",
			"[Misc] - [Auto Screenshot] Optimize the logic to only take one screenshot when multiple achievements are earned at the same time.",
		},
		["koKR"] = {
			...
			"[기타] - [자동 스크린샷] 리팩토링된 버전에서 스크린샷을 찍을 때 전투 알림을 자동으로 숨길 수 없는 문제를 수정했습니다.",
			"[기타] - [자동 스크린샷] 여러 업적을 동시에 획득할 때 한 번만 스크린샷을 찍도록 논리를 최적화했습니다.",
		},
		["ruRU"] = {
			...
			"[Разное] - [Автоматический скриншот] Исправлена проблема, из-за которой в переработанной версии не удавалось автоматически скрыть боевое оповещение при создании скриншотов.",
			"[Разное] - [Автоматический скриншот] Оптимизирована логика, чтобы при одновременном получении нескольких достижений делался только один скриншот.",
		},
	},
}
