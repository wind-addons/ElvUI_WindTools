...
W.Changelog[404] = {
	...
	IMPROVEMENT = {
		...
		["ruRU"] = {
			...
			"[Прямоугольная мини-карта] Дополнительно улучшена совместимость с аддонами, использующими библиотеку HereBeDragons-Pins, что позволяет более строго скрывать значки, выходящие за пределы прямоугольной мини-карты.",
		},
	},
}
