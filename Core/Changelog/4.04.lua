...
W.Changelog[404] = {
	...
	IMPROVEMENT = {
		...
		["ruRU"] = {
			...
			"[Игровая панель] При загрузке NetEase Meeting Stone кнопки LFG теперь автоматически изменяются на левый клик для открытия Meeting Stone и правый клик для открытия стандартного интерфейса LFG Blizzard.",
		},
	},
}
