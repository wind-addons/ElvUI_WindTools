...
W.Changelog[409] = {
	...
	IMPORTANT = {
		["zhCN"] = {
			...
			"[高级] 移除了战斗日志增强功能.",
			"[标签] 完全重构了标签模块, 你可以在 [其他] - [标签] 中找到新的可适用于新版 ElvUI 单位框体的标签.",
		},
		["zhTW"] = {
			"繼續優化至暗之夜API改動帶來的相容性問題.",
			"[進階] 移除了戰鬥日誌增強功能.",
			"[標籤] 完全重構了標籤模組, 你可以在 [其他] - [標籤] 中找到新的可適用於新版 ElvUI 單位框體的標籤.",
		},
		["enUS"] = {
			...
			"[Tags] Completely rebuilt the module, you can find the new tags applicable to the new ElvUI unit frames in [Misc] - [Tags].",
		},
		["koKR"] = {
			"미드나이트 API 변경으로 인한 호환성 문제를 지속적으로 최적화했습니다.",
			"[고급] 전투 로그 향상 기능이 제거되었습니다.",
			"[태그] 모듈이 완전히 재구성되었으며, [기타] - [태그]에서 새로운 ElvUI 유닛 프레임에 적용 가능한 태그를 찾을 수 있습니다.",
		},
		["ruRU"] = {
			...
			"[Теги] Модуль был полностью перестроен, новые теги, применимые к новым юнит-фреймам ElvUI, можно найти в разделе [Разное] - [Теги].",
		},
	},
	NEW = {
		["zhCN"] = {
