...
W.Changelog[409] = {
	...
	IMPORTANT = {
		...
		["ruRU"] = {
			...
			"[Меню правой кнопки мыши] Из-за проблемы с загрязнением кнопки 'Посетить дом' от Blizzard дополнительные параметры будут добавляться только при нажатии клавиши Shift при щелчке правой кнопкой мыши.",
