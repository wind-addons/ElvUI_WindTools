...
W.Changelog[409] = {
	...
	IMPROVEMENT = {
		["zhCN"] = {
			...
			"[游戏条] 修复了使用好友按钮打开好友框体之后, 住宅相关按钮无法正常使用的问题.",
		...
		["zhTW"] = {
			...
			"[遊戲條] 修復了使用好友按鍵打開好友框架之後, 住宅相關按鍵無法正常使用的問題.",
		...
		["koKR"] = {
			...
			"[게임 바] 친구 버튼을 사용하여 친구 프레임을 연 후 주택 관련 버튼을 정상적으로 사용할 수 없는 문제를 수정했습니다.",
		...
		["ruRU"] = {
			...
			"[Игровая панель] Исправлена ​​ошибка, из-за которой кнопки, связанные с жильем, не могли нормально использоваться после открытия окна друзей с помощью кнопки друзей.",
