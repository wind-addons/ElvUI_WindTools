...
W.Changelog[414] = {
	...
	IMPORTANT = {
		...
		["ruRU"] = {
			...
			"Отрегулированы названия и описания связанных с передачей квестов опций. Поскольку по умолчанию не будет автоматически передавать квесты, которые являются незавершенными для аккаунта и не ежедневными, вам нужно будет вручную включить условия в настройках, чтобы это было эффективно для всех квестов.",
		},
	},
	NEW = {
		["zhCN"] = {
