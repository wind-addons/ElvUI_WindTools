...
W.Changelog[415] = {
	...
	NEW = {
		["zhCN"] = {
			...
			"新增 [任务成就] - [怪物狩猎] 模块. 该模块能够在默认的进度 UI 上显示具体进度文字, 计划今后添加更多实用功能. 默认开启.",
		...
		["zhTW"] = {
			...
			"新增 [任務成就] - [怪物狩獵] 模組. 該模組能夠在預設的進度 UI 上顯示具體進度文字, 計劃今後添加更多實用功能. 預設開啟.",
		...
		["enUS"] = {
			...
			"Added a new module [Quest & Achieve] - [Prey Hunt]. This module can display specific progress text on the default progress UI, and more practical features are planned to be added in the future. Enabled by default.",
		...
		["koKR"] = {
			...
			"[퀘스트 & 업적] - [사냥감 사냥] 모듈이 추가되었습니다. 이 모듈은 기본 진행 UI에 특정 진행 텍스트를 표시할 수 있으며, 향후 더 많은 실용적인 기능이 추가될 예정입니다. 기본적으로 활성화되어 있습니다.",
		...
		["ruRU"] = {
			...
			"Добавлен новый модуль [Задания и достижения] - [Охота на добычу]. Этот модуль может отображать конкретный текст прогресса на стандартном UI прогресса, и в будущем планируется добавить больше практических функций. По умолчанию включено.",
