...
W.Changelog[415] = {
	...
	IMPROVEMENT = {
		...
		["enUS"] = {
			...
			"[Inspect] Updated the display logic for additional gem sockets in Shadowlands.",
		...
		["koKR"] = {
			...
			"[검사] 어둠땅에서 추가 보석 슬롯에 대한 표시 로직을 업데이트했습니다.",
		...
		["ruRU"] = {
			...
			"[Осмотр] Обновлена логика отображения дополнительных слотов для самоцветов в Темных Землях.",
