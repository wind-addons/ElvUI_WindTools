...
W.Changelog[415] = {
	...
	IMPROVEMENT = {
		...
		["ruRU"] = {
			...
			"[Контекстное меню] Ослаблена стратегия предотвращения ошибок Blizzard. Теперь для отображения меню при ПКМ на друга в Battle.net требуется нажать Ctrl, а в других случаях Ctrl больше не требуется.",
			...
			"[Прогресс] Настроены по умолчанию включенные специальные достижения M+.",
