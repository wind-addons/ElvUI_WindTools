...
W.Changelog[415] = {
	...
	IMPROVEMENT = {
		...
		["enUS"] = {
			...
			"[Skins] Optimized the skinning for widgets, supporting more progress bars.",
		...
		["koKR"] = {
			...
			"[스킨] 위젯 스킨을 최적화하여 더 많은 진행 바를 지원합니다.",
		...
		["ruRU"] = {
			...
			"[Скины] Оптимизировано оформление виджетов, поддерживается больше полос прогресса.",
