...
W.Changelog[416] = {
	...
	IMPORTANT = {
		...
		["enUS"] = {
			...
			"[Tooltip] - [Progress] The monster progress tips for world quests have added a lot of data for the Midnight Expansion, and more data will be added in future versions. Thanks to Dack",
		},
		["koKR"] = {
