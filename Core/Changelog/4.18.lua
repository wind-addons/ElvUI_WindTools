...
W.Changelog[418] = {
	...
	NEW = {
		["zhCN"] = {
			"[其他] - [静音] 新增了 黑曜夜之翼 的静音选项. 默认关闭.",
			"[美化外观] 新增了 [失控警报] 美化的独立选项. 默认开启.",
			"[其他] - [预创建队伍] 新增了右侧面板过滤按钮的提示信息选项. 默认开启.",
		},
		["zhTW"] = {
			"[雜項] - [靜音] 中新增了 黑曜夜翼 的靜音選項. 預設關閉.",
			"[美化外觀] 新增了 [失控警報] 美化的獨立選項. 預設開啟.",
			"[雜項] - [預組列表] 新增了右側面板過濾器按鈕的提示資訊選項. 預設開啟.",
		},
		["enUS"] = {
			"[Misc] - [Mute] Added a new mute option for Obsidian Nightwing. Disabled by default.",
			"[Skins] Added new independent options for [Loss of Control] skin. Enabled by default.",
			"[Misc] - [LFG List] Added a tooltip option for filter buttons in the right panel. Enabled by default.",
		},
		["koKR"] = {
			"[기타] - [음소거] 흑요석 밤날개표범 음소거 옵션이 추가되었습니다. 기본적으로 비활성화되어 있습니다.",
			"[스킨] [제어 상실] 스킨에 대한 새로운 독립 옵션이 추가되었습니다. 기본적으로 활성화되어 있습니다.",
			"[기타] - [파티 찾기 목록] 오른쪽 패널의 필터 버튼에 대한 툴팁 옵션이 추가되었습니다. 기본적으로 활성화되어 있습니다.",
		},
		["ruRU"] = {
			"[Разное] - [Отключение звуков] Добавлена новая опция отключения звука для Обсидианового ночного крыла. Отключено по умолчанию.",
			"[Скины] Добавлены новые независимые опции для скина [Потеря контроля]. Включено по умолчанию.",
			"[Разное] - [Поиск группы] Добавлена опция подсказки для кнопок фильтров на правой панели. Включено по умолчанию.",
		},
	},
	IMPROVEMENT = {
		["zhCN"] = {
