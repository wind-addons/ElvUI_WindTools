...
W.Changelog[413] = {
	...
	IMPORTANT = {
		...
		["ruRU"] = {
			...
			"[Трекер событий] События TWW по умолчанию отключены. События Миднайта будут добавлены после того, как мой персонаж достигнет максимального уровня.",
		},
	},
	NEW = {
		["zhCN"] = {
	...
	IMPROVEMENT = {
		...
		["ruRU"] = {
			...
			"[Подсказка] - [Комплект] Данные комплектов обновлены для Миднайта С1.",
			"[Подсказка] - [Настройки подсказки ElvUI] Исправлена функция вертикального смещения для полосы здоровья и текста здоровья.",
			"[Список ПГ] Фильтры подземелий обновлены для Миднайта С1.",
