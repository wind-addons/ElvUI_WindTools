...
W.Changelog[418] = {
	...
	IMPORTANT = {
		...
		["enUS"] = {
			...
			"Removed [Misc] - [Move Speed] module.",
		},
		["koKR"] = {
			"WoW 12.0.5와 호환됩니다.",
			"최소 요구 ElvUI 버전이 15.12로 변경되었습니다.",
			"LibOpenRaid 라이브러리가 업데이트되었습니다. Valdemar에게 감사드립니다.",
			"[호환성 검사] mMediaTag 호환성 검사가 최적화되었습니다. Merathilis에게 감사드립니다.",
			"[기타] - [이동 속도] 모듈이 제거되었습니다.",
		},
		["ruRU"] = {
			...
			"Удален модуль [Прочее] - [Скорость передвижения].",
		},
	},
	NEW = {
		["zhCN"] = {
	...
	IMPROVEMENT = {
		...
		["ruRU"] = {
			...
			"[Подсказки] - [Прогресс заданий] Добавлена поддержка отображения отслеживания прогресса. Спасибо Dack",
		},
	},
}
