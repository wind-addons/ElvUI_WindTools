-- 原作：ArtifactTab
-- 原作者：Ignifazius (https://www.curseforge.com/wow/addons/artifacttab)
-- 修改：houshuu
-------------------
-- 主要修改条目：
-- 模块化
...
local ArtifactFrameTab = E:NewModule('ArtifactFrameTab', 'AceHook-3.0', 'AceEvent-3.0', 'AceTimer-3.0');
-- 默认开启
P["WindTools"]["Artifact Frame Tab"] = {
	["enabled"] = true
}
local ArtifactTabDebug = false;
...
function ArtifactFrameTab:Initialize()
	if not E.db.WindTools["Artifact Frame Tab"]["enabled"] then return end
...
E:RegisterModule(ArtifactFrameTab:GetName())