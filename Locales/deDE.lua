...
L["Add an extra item level text to some equipment buttons."] = "Füge einigen Ausrüstungsschaltflächen einen zusätzlichen Gegenstandsstufentext hinzu."
...
L["Before you submit a bug, please enable debug mode with %s command and test one more time."] = "Bevor Du einen Fehler meldest, aktiviere bitte den Debug Modus mit dem %s-Befehl und testen es noch einmal."
