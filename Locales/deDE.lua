...
L["Add a button to open soulbind frame."] = true
...
L["Automatically activate the soulbind when you changing covenant."] = true
...
L["Change the spells in action bars and the soulbind when you changing covenant."] = true
...
L["Confirm your choice of the soulbind"] = true
...
L["Delete all saved talent sets."] = true
...
L["If the rule not set, it will display a popup to remind you of changing soulbind."] = true
...
L["If you set auto activate rule for current player, it will not be displayed."] = true
...
L["Show reminder after you changing covenant."] = true
