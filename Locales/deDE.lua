...
L["Auto track the waypoint after setting."] = "Verfolgt automatisch gesetzte Wegpunkte."
L["Auto-detect"] = true
...
L["Use Emote Panel"] = "Benutze Emote Leiste"
...
L["Welcome to %s %s!"] = "Willkommrn zu %s %s!"
L["Whisper"] = "Flüstern"
