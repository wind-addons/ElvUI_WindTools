...
L["%player% is casting %spell%, please assist!"] = "¡%player% lanza %spell%, por favor asistid!"
...
L["%player% taunted %target% successfully!"] = "¡%player% provocó a %target% correctamente!"
L["%player% taunted all enemies!"] = "¡%player% provocó a todos los enemigos!"
L["%player% used %spell%"] = "%player% usó %spell%"
L["%player%'s %pet_role% %pet% failed on taunting %target%!"] = "¡%player%'s %pet_role% %pet% falló en provocar a %target%!"
L["%player%'s %pet_role% %pet% taunted %target% successfully!"] = "¡%player%'s %pet_role% %pet% provocó a %target% correctamente!"
...
L["Because of Blizzard 'Visit Home' button taint issue, the additional options only will be added when you pressing Shift key while right-clicking."] = "Debido al problema de contaminación del botón 'Visitar hogar' de Blizzard, las opciones adicionales solo se añadirán cuando pulses Shift mientras haces clic derecho."
...
L["Enable Conditions"] = "Condiciones de activación"
...
L["Fix the issues caused by Blizzard."] = "Corregir los problemas causados por Blizzard."
...
L["Midnight API Fix"] = "Corrección de API de Medianoche"
...
L["My %pet_role% %pet% failed on taunting %target%!"] = "¡Mi %pet_role% %pet% falló al provocar a %target%!"
L["My %pet_role% %pet% taunted %target% successfully!"] = "¡Mi %pet_role% %pet% provocó a %target% con éxito!"
...
L["O"] = "O"
L["OMG, wealthy %player% puts %spell%!"] = "¡OMG, el rico %player% pone %spell%!"
...
L["Use command %s to view all handled buttons and their current sorting priority."] = "Usa el comando %s para ver todos los botones gestionados y su prioridad de ordenación actual."
