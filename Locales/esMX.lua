...
L["%player% cast %spell%, today's special is Anchovy Pie!"] = "¡%player% lanza %spell%, el especial de hoy es Tarta de Anchoas!"
...
L["%s + Left Click to mark the target with this mark."] = "%s + Clic Izquierdo para marcar el objetivo con esta marca."
L["%s + Left Click to place this worldmarker."] = "%s + Clic Izquierdo para colocar esta marca de mundo."
L["%s + Right Click to clear the mark on the target."] = "%s + Clic Derecho para limpiar la marca del objetivo."
L["%s + Right Click to clear this worldmarker."] = "%s + Clic Derecho para limpiar esta marca de mundo."
