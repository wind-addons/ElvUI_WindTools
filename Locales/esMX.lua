...
L["Show an icon for items and spells."] = "Mostrar un icono para objetos y hechizos."
...
L["The localization of %s is community-driven."] = "La localización de %s es impulsada por la comunidad."
...
L["To enable this skin, you need download %s from CurseForge"] = "Para habilitar esta skin, necesitas descargar %s desde CurseForge"
...
L["Ublock the profanity filter and disable model override."] = "Desbloquea el filtro de palabras soeces y desactiva el reemplazo de modelos."
