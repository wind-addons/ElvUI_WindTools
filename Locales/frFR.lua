...
L["Add a bar contains buttons to enable/disable modules quickly."] = "Ajoute une barre avec des boutons pour activer/désactiver les modules rapidement."
...
L["Alliance"] = "Alliance"
L["Allow you to save outfits even if the artifact in it."] = "Vous permet de sauvegarder vos ensembles d'armures même s'il y a un artefact dedans."
...
L["Press modifier key (Shift, Ctrl, Alt) to stop the automation temporarily."] = "Appuyer sur la touche de modification (Maj, Ctrl, Alt) pour arrêter temporairement l'automatisation."
...
L["Remove Fog"] = "Enlever le brouillard"
...
L["Save Artifact"] = "Enregistrer l'artefact"
...
L["The addon message prefix registration has failed."] = "L'enregistrement du préfixe du message complémentaire a échoué."
