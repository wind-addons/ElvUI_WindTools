...
L["Drag"] = "Glisser"
L["Dragon"] = "Dragon"
L["Dragonbane Keep"] = "Fléau-des-Dragons"
...
L["Fix the bug that you will see Lua error when you using LFG frame."] = "Corriger le bug qui provoque une erreur Lua lorsque vous utilisez le cadre Recherche de groupe."
L["Fix the bug that you will see duplicated party in lfg frame."] = "Corriger le bug qui provoque l'affichage en double d'un groupe dans le cadre Recherche de groupe."
...
L["Middle click the waypoint to clear it."] = "Cliquez du milieu sur le waypoint pour le supprimer."
L["Minimap"] = "Minicarte"
...
L["Time Rift Thaldraszus"] = "Thaldraszus"
