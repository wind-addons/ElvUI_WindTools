...
L["%player% has earned the achievement %achievement%!"] = "%player% a obtenu le haut fait %achievement% !"
L["%players% (%bnet%) has come online."] = "%players% (%bnet%) est en ligne."
L["%players% (%bnet%) has gone offline."] = "%players% (%bnet%) est hors ligne."
L["%players% have earned the achievement %achievement%!"] = "%players% ont obtenu le haut fait %achievement%!"
L["%s %s Loaded."] = "%s %s est chargé."
L["%s + Click to clear all marks."] = "%s + Cliquer pour effacer toutes les marques."
L["%s + Click to remove all world markers."] = "%s + Cliquer pour supprimer tous les marqueurs de terrain."
L["%s + Left Click to mark the target with this mark."] = "%s + clic gauche pour marquer la cible avec cette marque."
L["%s + Left Click to place this world marker."] = "%s + clic gauche pour placer ce marqueur de terrain."
L["%s + Right Click to clear the mark on the target."] = "%s + clic droit pour effacer la marque de la cible."
L["%s + Right Click to clear this world marker."] = "%s + clic droit pour effacer ce marqueur de terrain."
...
L["%s detects CVar %s has been changed."] = "%s détecte que la CVar %s a été modifié."
...
L["Accept and Complete"] = "Accepter et terminer"
...
L["Active Layout"] = "Disposition active"
L["Add"] = "Ajouter"
...
L["Add an additional frame to show party members' keystone."] = "Ajoute un cadre supplémentaire pour montrer les clef des membres du groupe."
...
L["Additional UI enhancements for Prey Hunt."] = "Améliorations d'interface supplémentaire pour les traques."
L["Additional features for waypoint."] = "Fonctionnalités supplémentaires pour les points de passage."
L["Addon Profiler"] = true
L["Addons"] = "Addons"
L["Adjust the font size of the right panel."] = "Ajuster la taille de la police du panneau de droite."
L["Advanced"] = "Avancé"
...
L["Affixes"] = true
L["After you stop debugging, %s will reenable the addons automatically."] = "Après l'arrêt du débogage, %s réactivera automatiquement les modules complémentaires."
L["AiFaDian"] = true
L["Alert"] = "Alerte"
...
L["Automatic filters behavior"] = "Comportement des filtres automatiques"
...
L["Change the position of the health bar."] = "Change la position de la barre de vie."
L["Change the position of the health text."] = "Change la position du texte indiquant la vie"
...
L["Click to remove all world markers."] = "Cliquer pour supprimer tous les marqueurs de terrain."
...
L["Codes"] = "Codes"
L["Collapse"] = true
L["Collapse Button"] = "Bouton de réduction"
...
L["Debug Environment"] = "Environnement de débogage"
...
L["Disable the default behavior that prevents inconsistent filters with flags 'Has Tank', 'Has Healer' and 'Role Available'"] = "Désactiver le comportement par défaut qui empêche les filtres incohérents avec les indicateurs 'A un Tank', 'A un Healer' et 'Rôle disponible'"
...
L["Fix MawBuffs"] = "Corriger les améliorations de l'Antre"
...
L["Skip Blizzard Maw buff checks while auras are secret so tainted Objective Tracker updates do not error."] = "Ignore les vérifications d'améliorations de l'Antre lorsque les auras sont secrètes, afin que les mises à jour contaminées du suivi d'objectifs ne provoquent pas d'erreur."
...
L["Hide Combat Alert"] = "Masquer l'alerte de combat"
...
L["Ignore Earned Before"] = "Ignorer déjà obtenu"
...
L["In Arena"] = "En arène"
L["In Battleground"] = "En champs de bataille"
L["In Combat"] = "En combat"
L["In Dungeon"] = "En donjon"
...
L["Information Color"] = "Couleur d'information"
...
L["Leave Combat"] = "Sortir de combat"
L["Leave Delve"] = "Quitter le gouffre"
L["Leave Party"] = "Quitter le groupe"
...
L["Left Click to place this world marker."] = "Clic gauche pour placer ce marqueur de terrain."
...
L["Not Accepted"] = "Pas accepté"
L["Not Completed"] = "Pas achevé"
L["Not Equipped"] = "Pas équipé"
L["Not Set"] = true
...
L["Out of Instance"] = "Hors instance"
...
L["Reverse the sort order of buttons."] = "Inverser l'order de tri des boutons."
L["Reward"] = "Récompense"
...
L["Right Click to clear this world marker."] = "Clic droit pour effacer ce marqueur de terrain."
...
L["The class icon of %s"] = "L'icône de classe de %s"
...
L["This is a test message"] = "Ceci est un message de test"
...
L["Weekly Quest"] = "Quête hebdomadaire"
...
L["Yell"] = "Crier"
L["Yellow"] = "Jaune"
L["You are not in a party."] = "Vous n'êtes pas dans un groupe."
