...
L["Add a glow in the end of health bars to indicate the over absorb."] = "과도한 Absorb를 나타내기 위해 체력 표시줄 끝에 빛을 추가합니다"
...
L["Add an additional overlay to the absorb bar."] = "Absorb 바에 오버레이를 추가합니다"
...
L["Add the Blizzard over absorb glow and overlay to ElvUI unit frames."] = "ElvUI 유닛 프레임에 블리자드 스타일의 Absorb glow 및 오버레이를 추가합니다."
...
L["Change the color of the absorb bar."] = "Absorb 바의 색상을 변경합니다."
...
L["Enable"] = "활성"
L["Enable All"] = "모두 활성"
L["Enable the replacing of ElvUI absorb bar textures."] = "ElvUI Absorb 바 텍스쳐 교체를 활성화합니다."
...
L["Here are some buttons for helping you change the setting of all absorb bars by one-click."] = "다음은 한 번의 클릭으로 모든 Absorb 바의 설정을 변경하는 데 도움이 되는 몇 가지 버튼입니다."
L["Heroic"] = "영웅"
...
L["Modify the texture of the absorb bar."] = "Absorb 바의 텍스쳐를 수정합니다."
L["Module"] = "모듈"
L["Modules"] = "모듈"
L["Monk"] = "수도사"
L["Monochrome"] = "단색화"
...
L["Server List"] = "서버 목록"
L["Set %s to %s"] = "%s을(를) %s(으)로 설정"
L["Set All Absorb Style to %s"] = "모든 Absorb Style을 %s(으)로 설정"
L["Set Area"] = "지역 설정"
...
L["The selected texture will override the ElvUI default absorb bar texture."] = "선택한 텍스쳐는 ElvUI 기본 Absorb 바 텍스쳐를 무시합니다."
...
L["Use the texture from Blizzard Raid Frames."] = "Blizzard 공격대 프레임의 텍스처를 사용합니다."
L["Utilities"] = "유틸리티"
L["Utility"] = "유틸리티"
L["Value Color"] = "강조 색상"
L["Venthyr"] = "벤티르"
