...
L["%player% is handing out cookies, go and get one!"] = "%player%이(가) 사탕을 나눠 주고 있습니다. 하나 가져가세요!"
...
L["Add a contact frame beside the mail frame."] = "우편 발송시 연락처 창을 추가 합니다."
...
L["Add more custom options to ElvUI cast bars."] = "ElvUI 시전 바에 더 많은 사용자 지정 옵션을 추가합니다."
...
L["Alert teammates that the threat transfer spell being used."] = "팀원에게 위협 수준을 이전하는 기술 사용에 대해 알립니다."
L["Alliance"] = "얼라이언스"
...
L["Input Method Editor"] = "입력기 (중국어, 일본어, 한자등)"
L["Inspect"] = "살펴보기"
L["Instance"] = "인스턴스"
L["Interrupt"] = "차단 알림"
...
L["Skipped the cutscene."] = "건너 뛴 컷신"
L["Slow Mode"] = true
L["Smart Tab"] = "스마트 탭"
L["Social"] = "소셜"
L["Solo"] = "솔플"
