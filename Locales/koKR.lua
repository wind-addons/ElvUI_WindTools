...
L["Set to 1 if you do not understand the meaning of log level."] = "로그 레벨의 의미를 잘 모를 경우 1로 설정하세요."
L["Shadow"] = "그림자"
...
L["You can use |cff00ff00/wtdebug off|r command to exit debug mode."] = "|cff00ff00/wtdebug off|r 명령을 사용하여 디버그 모드를 종료할 수 있습니다."
