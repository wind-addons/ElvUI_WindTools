...
L["%s style absorb color"] = "%s 스타일의 보호막 바 색상"
...
L["Add a glow in the end of health bars to indicate the over absorb."] = "초과 피해 흡수를 나타내기 위해 체력 표시줄 끝에 빛을 추가합니다"
...
L["Add an additional overlay to the absorb bar."] = "보호막 바에 오버레이를 추가합니다"
...
L["Add the Blizzard over absorb glow and overlay to ElvUI unit frames."] = "ElvUI 유닛 프레임에 블리자드 스타일의 초과 피해 흡수 효과 및 오버레이를 추가합니다."
...
L["Blanchard"] = true
L["Blizzard"] = true
L["Blizzard Absorb Overlay"] = "블리자드 보호막 오버레이"
L["Blizzard Buttons"] = "블리자드 버튼"
L["Blizzard Over Absorb Glow"] = "블리자드 초과 피해 흡수 효과"
...
L["Enable"] = "활성"
L["Enable All"] = "모두 활성"
L["Enable the replacing of ElvUI absorb bar textures."] = "ElvUI 보호막 바 텍스처 교체를 활성화합니다."
...
L["Here are some buttons for helping you change the setting of all absorb bars by one-click."] = "다음은 한 번의 클릭으로 모든 보호막 바의 설정을 변경하는 데 도움이 되는 몇 가지 버튼입니다."
L["Heroic"] = "영웅"
...
L["Modify the texture of the absorb bar."] = "보호막 바의 텍스처를 수정합니다."
L["Module"] = "모듈"
L["Modules"] = "모듈"
L["Monk"] = "수도사"
L["Monochrome"] = "단색화"
...
L["Set All Absorb Style to %s"] = "모든 보호막 스타일을 %s(으)로 설정"
L["Set Area"] = "지역 설정"
...
L["The absorb style %s and %s is highly recommended with %s tweaks."] = "보호막 스타일을 %s 및 %s로 설정하여 %s의 수정과 함께 표시하는 것을 강력히 추천합니다."
...
L["The selected texture will override the ElvUI default absorb bar texture."] = "선택한 텍스쳐는 ElvUI 기본 보호막 바 텍스처를 무시합니다."
