...
L["%player% casted %spell%, today's special is Anchovy Pie!"] = "%player%이(가) %spell%을(를) 시전했습니다. 물빵 가져 가세요!"
L["%player% failed on taunting %target%!"] = "%player% -> %target% 도발 실패!"
L["%player% interrupted %target%'s %target_spell%!"] = "%player%이(가) %target%의 %target_spell%을(를) 차단했습니다!"
L["%player% is casting %spell%, please assist!"] = "%player%이(가) %spell%을(를) 시전하고 있습니다. 도와 주세요!"
L["%player% is handing out cookies, go and get one!"] = "%player%이(가) 사탕을 나눠 주고 있습니다. 하나 가져 가세요!"
L["%player% opened %spell%!"] = "%player%이(가) %spell%을(를) 열었습니다!"
L["%player% puts %spell%"] = "%player%이(가) %spell%을(를) 꺼냈습니다."
L["%player% taunted %target% successfully!"] = "%player% -> %target% 도발 성공!"
L["%player% taunted all enemies in 10 yards!"] = "%player%이(가) 10미터 내에 있는 모든 적을 도발합니다!"
L["%player% used %spell%"] = "%player% 이(가) %spell%을(를) 사용합니다."
...
L["%s has been added to the ignore list."] = "%s이(가) 무시 목록에 추가되었습니다."
L["%s has been reset"] = "%s이(가) 리셋되었습니다."
...
L["%target%, thank you for using %spell% to revive me. :)"] = "%target%님 살려 줘서 고마워요! :)"
...
L["In Party"] = "파티 중일 때"
L["In Raid"] = "공격대 안일 때"
L["In Shadowlands (9.0) pre-patch, %s has been rewritten, such that possibly there are bugs somewhere."] = "어둠땅 사전 패치에서 %s가 다시 작성되어 어딘가에 버그가 있을 수 있습니다."
...
L["Move Speed"] = "이동 속도"
L["Mute"] = "음소거"
L["My %pet_role% %pet% failed on taunting %target%!"] = "%pet_role% %pet%이(가) %target%을(를) 도발하는 데 실패했습니다."
L["My %pet_role% %pet% taunted %target% successfully!"] = "%pet_role% %pet%이(가) %target%을(를) 도발하는 데 성공했습니다."
...
L["O"] = "관리자"
L["OMG, wealthy %player% puts %spell%!"] = "이럴 수가!! 부유한 %player%이(가) %spell%을(를) 차렸습니다!"
L["OUTLINE"] = true
...
L["[ABBR] Finger"] = "손가락"
L["[ABBR] Guild"] = "G"
L["[ABBR] Halls of Atonement"] = "속죄전당"
L["[ABBR] Hands"] = "손"
L["[ABBR] Head"] = "머리"
