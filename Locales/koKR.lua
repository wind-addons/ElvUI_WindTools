...
L["Export the setting of %s that stored in ElvUI Private database."] = "ElvUI 개인(Private) 데이터베이스에 저장된 %s의 설정을 내 보냅니다."
L["Export the setting of %s that stored in ElvUI Profile database."] = "ElvUI 프로필(Profile) 데이터베이스에 저장된 %s의 설정을 내 보냅니다."
...
L["Import and export your %s settings."] = "%s의 설정을 가져오거나 내 보냅니다."
L["Important"] = "중요 사항"
L["Improvement"] = "개선 사항"
...
L["It will override your %s setting."] = "%s의 설정을 변경합니다."
L["Item"] = "아이템"
