...
L["%player% casted %spell% -> %target%"] = "%player% применяет %spell% -> %target%"
L["%player% casted %spell%, today's special is Anchovy Pie!"] = "%player% применяет %spell%, особенное блюдо сегодняшнего дня - пирог с анчоусами!"
...
L["Abbreviation Customization"] = "Настройка Сокращений"
...
L["Add a frame to Inspect Frame."] = "Добавляет рамку в Inspect Frame."
L["Add a frame to your character panel."] = "Добавляет рамку на панель вашего персонажа."
...
L["Add additional information to the friend frame."] = "Добавляет дополнительную информацию в фрейм друга."
...
L["Add some features on Trade Frame."] = "Добавляет некоторые функции в фрейм обмена."
...
L["Always Show Info"] = "Всегда показывать информацию"
L["Always Show Mine"] = "Всегда показывать шахту"
...
L["Azeroth Auto Pilot"] = "Автопилот Азерота"
L["BOTTOM"] = true
L["BOTTOMLEFT"] = true
L["BOTTOMRIGHT"] = true
L["Backdrop"] = "Фон"
...
L["Class Bars"] = "Шкалы классов"
L["Class Color"] = "Цвет класса"
L["Clear All Sets"] = "Очистить все наборы"
L["Clear History"] = "Очистить историю"
L["Click to clear all marks."] = "Щелкните, чтобы удалить все отметки."
L["Click to confirm"] = "Нажмите, чтобы подтвердить"
L["Click to remove all worldmarkers."] = "Щелкните, чтобы удалить все мировые метки."
...
L["Credits & help."] = "Кредиты и помощь."
...
L["Demon Fall Canyon"] = "Каньон Падения Демонов"
...
L["In Party"] = "В группе"
L["In Raid"] = "В рейде"
L["In Shadowlands (9.0) pre-patch, %s has been rewritten, such that possibly there are bugs somewhere."] = "В предварительном патче Shadowlands (9.0) %s был переписан, так что, возможно, где-то есть ошибки."
...
L["Maw Buff On Right"] = "Maw Buff справа"
...
L["Move Speed"] = "Скорость движения"
L["Mute"] = "Без звука"
...
L["Only Not Tank"] = "Только не танк"
L["Only Number"] = "Только номер"
L["Only On Combat"] = "Только в бою"
L["Only You"] = "Только вы"
L["Only announce when the target is not a tank."] = "Объявлять только тогда, когда цель - не танк."
...
L["Parse emote expresstion from other players."] = "Анализируйте выражения смайлов от других игроков."
L["Party"] = "Группа"
...
L["Please enable Emote module in WindTools Social category."] = "Пожалуйста, включите модуль Emote в категории WindTools Social."
...
L["Please use Blizzard Communities UI add the channel to your main chat frame first."] = "Пожалуйста, используйте интерфейс сообществ Blizzard, сначала Добавляет канал в основной фрейм чата."
L["Portals"] = "Порталы"
L["Position"] = "Позиция"
L["Potions"] = "Зелья"
L["Power"] = "Ресурс"
L["Prefix"] = "Приставка"
L["Premade Groups Filter"] = "Фильтр собранных групп"
...
L["Range"] = "Радиус"
L["Range Expectation"] = "Ожидание диапазона"
L["Raw Mouse"] = "Raw мыши"
L["Raw Mouse Acceleration"] = "Raw ускарения мыши"
L["Ready"] = "Готовность"
...
L["This module will accelerate the speed of loot."] = "Этот модуль ускорит скорость добычи."
...
L["Use faction icon instead of WoW icon."] = "Используйте значок фракции вместо значка WoW."
