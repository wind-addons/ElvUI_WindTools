...
L["Add a small icon to indicate the highest score."] = "Добавить маленькую иконку, указывающую на наивысший балл."
...
L["Druid"] = "Друид"
L["Dungeon Score Over"] = "Подземелье закончилось"
...
L["Enable this filter will only show the group that you can join with your friends."] = "При включении этого фильтра будут показаны только те группы, в которые Вы можете вступить вместе со своими друзьями."
...
L["It only works when you in a group."] = "Это работает только тогда, когда Вы в группе."
...
L["It will check the role of current party members."] = "Это проверит роль текущих участников группы."
...
L["Join Together"] = "Присоединиться вместе"
...
L["Leader Score Over"] = "Счет лидера превышен"
...
L["Reskin the instance diffculty in text style."] = "Изменить сложность подземелья в стиле текста."
