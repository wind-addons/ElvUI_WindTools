...
L["%player% failed on taunting %target%!"] = "%player% не удалось затаунтить %target%!"
...
L["%player% is handing out cookies, go and get one!"] = "%player% раздает печенье, идите и возьмите себе!"
L["%player% opened %spell%!"] = "%player% открыл %spell%!"
L["%player% puts %spell%"] = "%player% ставит %spell%"
L["%player% taunted %target% successfully!"] = "%player% затаунтил %target% успешно!"
L["%player% taunted all enemies!"] = "%player% затаунтил всех врагов!"
L["%player% used %spell%"] = "%player% использует %spell%"
L["%player%'s %pet_role% %pet% failed on taunting %target%!"] = "%player%'s %pet_role% %pet% не удалось затаунтить %target%!"
L["%player%'s %pet_role% %pet% taunted %target% successfully!"] = "%player%'s %pet_role% %pet% затаунтил %target% успешно!"
...
L["Disable announcement in open world."] = "Отключить оповещения в открытом мире."
...
L["Fix the issues caused by Blizzard."] = "Исправление проблем, вызванных действиями Blizzard."
...
L["Midnight"] = "Полночь"
L["Midnight API Fix"] = "Исправление API в 'Полночи'"
...
L["No weekly runs found."] = "Еженедельные забеги не найдены."
L["None"] = "Нет"
L["Normal"] = "Обычный"
...
L["Player(Only you)"] = "Игрок (только Вы)"
