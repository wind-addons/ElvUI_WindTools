...
L["Show an icon for items and spells."] = "Показывать иконку для предметов и заклинаний."
...
L["Show the icon of the player race."] = "Показать иконку расы игрока."
L["Show the icon of the specialization."] = "Показать иконку специализации."
