...
L["Add LFG group info to tooltip."] = "Добавьте информацию о группе LFG во всплывающую подсказку."
...
L["Add a bar to contain quest items and usable equipment."] = "Добавьте панель, содержащую квестовые предметы и полезное оборудование."
L["Add a chat bar for switching channel."] = "Добавьте панель чата для переключения канала."
L["Add a contact frame beside the mail frame."] = "Добавьте рамку контакта рядом с рамкой почты."
L["Add a frame to Inspect Frame."] = "Добавьте рамку в Inspect Frame."
L["Add a frame to your character panel."] = "Добавьте рамку на панель вашего персонажа."
L["Add a game bar for improving QoL."] = "Добавьте игровую панель для упрощения жизни."
L["Add a line in class color."] = "Добавьте строку в цвет класса."
L["Add a lot of QoL features to WoW."] = "Добавьте в WoW множество функций упрощающих жизнь."
L["Add additional information to the friend frame."] = "Добавьте дополнительную информацию в фрейм друга."
L["Add an extra bar to collect minimap buttons."] = "Добавьте дополнительную панель для сбора кнопок миникарты."
L["Add an extra bar to let you set raid markers efficiently."] = "Добавьте дополнительную панель, позволяющую эффективно устанавливать маркеры рейда."
