...
L["Use command %s to view all handled buttons and their current sorting priority."] = "Используйте команду %s для просмотра всех обработанных кнопок и их текущего приоритета сортировки."
