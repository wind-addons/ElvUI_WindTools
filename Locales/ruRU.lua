...
L["%player% used %spell%, please assist!"] = "%player% использует %spell%, пожалуйста, помогите!"
...
L["Legion Assault"] = "Атака Легиона"
L["Legion Assault (Remix)"] = "Атака Легиона (Remix)"
...
L["Only Remix Character"] = "Только персонаж Remix"
...
L["Stop alert when the player is not in Remix mode."] = "Отключить оповещение, если игрок не находится в режиме Remix."
