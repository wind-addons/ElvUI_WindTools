...
L["Show the bar only when the mouse is hovered over the area."] = "Показать панель только при наведении мыши."
...
L["Stop alert when the player has not entered Dragonlands yet."] = "Прекратить оповещения, когда игрок еще не вошел в Драконьи земли"
