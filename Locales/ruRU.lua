...
L["Only set raid markers on castable targets to prevent 'invalid target' errors by avoiding enemy players."] = "Устанавливать метки рейда только на те цели, на которые можно применять заклинания, чтобы предотвратить ошибки по типу 'неверная цель', избегая вражеских игроков."
