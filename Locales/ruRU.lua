...
L["%s contains the quest level."] = "%s содержит уровень квеста."
L["%s contains the quest objective progress."] = "%s содержит прогресс выполнения цели задания."
L["%s contains the quest tag, which is typically the quest series name."] = "%s содержит тег квеста, который обычно является названием серии заданий."
L["%s contains the quest title."] = "%s содержит название квеста."
L["%s contains the suggested group size for the quest."] = "%s содержит рекомендуемый размер группы для квеста."
...
L["Because the quest announcement is actually an extension of the %s module."] = "Оповещение о квесте на самом деле является расширением модуля %s."
...
L["Do not show quest level if the quest level is the same as the maximum level of your current expansion."] = "Не показывать уровень задания, если уровень квеста совпадает с максимальным уровнем Вашего текущего дополнения WoW."
L["Do not show quest level if the quest level is the same as your current level."] = "Не показывать уровень задания, если уровень квеста такой же, как Ваш текущий уровень."
