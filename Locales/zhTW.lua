...
L["Use raid warning when you is raid leader or assistant."] = "在你是RL或是有助理權限的時候使用團隊警告"
...
L["In instance"] = "在副本中"
L["In raid"] = "在團隊副本中"
L["I interrupted %target%\'s %target_spell%!"] = "我已斷法 %target% 的 %target_spell%！"
L["%player% interrupted %target%\'s %target_spell%!"] = "%player% 已斷法 %target% 的 %target_spell%！"
L["Combat resurrection"] = "戰鬥復活"
L["Threat transfer"] = "仇恨轉移"
L["%player% is casting %spell%, please assist!"] = "%player% 正在進行 %spell%，請配合點門哦！"
L["%player% is handing out cookies, go and get one!"] = "%s 發糖了，快點拿喲！"
...
L["My %pet% taunted %target% successfully!"] = "我的 %pet% 成功嘲諷了 %target%！"
L["My %pet% failed on taunting %target%!"]= "我的 %pet% 嘲諷 %target% 失敗！"
L["%player% taunted %target% successfully!"] = "%player% 成功嘲諷了 %target%！"
L["%player% failed on taunting %target%!"] = "%player% 嘲諷 %target% 失敗！"
L["%player%'s %pet% taunted %target% successfully!"] = "%player% 的 %pet% 嘲諷 %target% 失敗！"
L["%player%'s %pet% failed on taunting %target%!"] = "%player% 的 %pet% 嘲諷 %target% 失敗！"