...
L["Add progress information (Ex. Mob 10/25)."] = "添加進度信息 (例：暴徒 10/25)"
...
L["Changes the rate at which your mouse pointer moves based on the speed you're moving the mouse."] = "系統將會基於你移動滑鼠的速度來改變光標移動的速度倍率."
L["Channel Name"] = "頻道名"
L["Chat Bar"] = "聊天條"
