...
L["%s is a plugin for ElvUI that consists of my original plugins and several plugins developed by other players."] = "%s 是一個ElvUI 插件, 包含了我的許多原創插件及其他作者的優秀插件功能."
...
L["In Party"] = "在隊伍中"
L["In Raid"] = "在團隊副本中"
L["In Shadowlands (9.0) pre-patch, %s has been rewritten, such that possibly there are bugs somewhere."] = "在暗影之境 (9.0) 更新前夕, %s 已被完整重寫, 因此有些 Bug 在所難免."
...
L["Role Icon"] = "角色圖示"
L["Roll"] = "擲骰"
L["Run Lua garbage collection periodically."] = "定期執行 Lua 垃圾回收."
...
L["Show the bar only mouse hovered the area."] = "僅在鼠標滑過區域時顯示條."
