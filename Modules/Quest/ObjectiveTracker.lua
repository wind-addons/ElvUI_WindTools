...
function OT:QUEST_DETAIL()
	if(not QuestGetAutoAccept()) then
		AcceptQuest()
	end
end

function OT:QUEST_ACCEPT_CONFIRM()
	AcceptQuest()
end

function OT:QUEST_ACCEPTED()
...
function OT:PLAYER_LOGIN()
    AttemptAutoComplete("PLAYER_LOGIN")
end

function OT:QUEST_AUTOCOMPLETE()
...
function OT:Initialize()
    ...
    WT.UpdateSwitchButton = function()
        OT:RefreshSwitchButton()
    end
