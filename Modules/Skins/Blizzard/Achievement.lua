...
local function SkinAchievementFrame(tried)
    ...
    if _G.AchievementFramePixelBorderCENTER then
        ...
        if tried < 20 then E:Delay(.1, function() SkinAchievementFrame(tried) end) end
    end
end
...
function S:Blizzard_AchievementUI()
    ...
    if not (E.private.WT.skins.blizzard.enable and E.private.WT.skins.blizzard.achievement) then return end
