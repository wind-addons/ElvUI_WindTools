...
function S:Blizzard_Collections()
    ...
    if not (E.private.WT.skins.blizzard.enable and E.private.WT.skins.blizzard.collections) then return end

    S:CreateShadow(_G.CollectionsJournal)
    S:CreateShadow(_G.WardrobeFrame)

    for i = 1, 5 do S:CreateBackdropShadowAfterElvUISkins(_G["CollectionsJournalTab" .. i]) end
end
