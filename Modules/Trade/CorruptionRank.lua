...
local tip = CreateFrame("GameTooltip", "Wind_CorruptionRankTooltip", UIParent, "GameTooltipTemplate")
...
function CR:Corruption_CreateEye()
	if not InspectFrame.__eye then
        ...
        eye:SetScript("OnLeave", function()
            GameTooltip:Hide()
        end)
...
function CR:Initialize()
	...
	tinsert(WT.UpdateAll, function()
		CR.db = E.db.WindTools["Trade"]["Corruption Rank"]
	end)
