...
## 任务
1. **任务列表**: 自定义任务追踪框架的文字风格, 排列等等!  
2. **交接**: 自动交接任务, 包括一些例如追随者招募框架的自动化, 可自定义黑名单.  
...
8. **智能 Tab**: 使用Tab来进行聊天频道循环, 可设置不常用频道, 跨帐号密语历史等.
...
6. **告别**: 副本结束的时候和队友说再见, 做个有礼貌的人!
7. **感谢复活**: 感谢他人的复活, 可设定延迟等.
8. **副本重置**: 副本重置后进行喊话.
