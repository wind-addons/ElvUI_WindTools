...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-4.16-538AED.svg?longCache=true&style=for-the-badge)
![ElvUI 版本](https://img.shields.io/badge/ElvUI-15.09-ff784d.svg?longCache=true&style=for-the-badge)
...
2. **矩形小地图**：让小地图的长宽独立设置，打造矩形外观。
3. **小地图按钮**：将所有小地图按钮集中到一条按钮条中，可自定义布局、排序以及版本大厅按钮支持。
4. **世界地图**：移除世界地图迷雾或自定义迷雾颜色，可根据需要缩放地图。
5. **副本难度**：以文字样式重新美化副本难度指示，并可自定义字体与文本。
6. **事件追踪器**：在世界地图跟踪 TWW 周常、夜幕、剧团、光耀回响、巨龙群岛事件等世界事件，并提供可配置的提醒与音效。
...
2. **告别**：副本或团队结束后自动发送告别语，可设置延迟与文本。
3. **副本重置**：重置副本后提醒队友。
4. **钥石**：通报大秘境钥石信息，并提供自定义文本格式。
