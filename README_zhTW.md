...
![版本](https://img.shields.io/badge/%E7%89%88%E6%9C%AC-4.00-538AED.svg?longCache=true&style=for-the-badge)
...
[简体中文 (zhCN)](README_zhCN.md) | 繁體中文 (zhTW) | [English (enUS)](README.md) | [Español (esES/esMX)](README_esES.md)
...
4. **交易**: 快速感謝交易目標
5. **額外物品條**: 添加幾個額外智能快捷列來放置任務物品，藥水，藥劑，戰旗，等等。按鍵大小，背景，順序和物品分組都可自訂
...
2. **聊天鏈接**: 為聊天中的物品鏈接，技能鏈接提供快速標識，圖標等
3. **聊天文字**: 更加全面的頻道縮寫，替換角色定位圖標，去除方括號，去除服務器等
4. **右鍵選單**: 一個安全無污染的右鍵選單，支持邀請加入公會，好友申請，英雄榜等
5. **表情**: 解析並提供一個面板來發送表情，可與大腳，魔盒，WeakAuras 聊天條等完美兼容
6. **好友名單**: 智能顯示等級，陣營，位置等信息，支持職業染色，遊戲染色，文字風格設置
7. **智能 Tab**: 使用 Tab 來進行聊天頻道循環，可設置不常用頻道，跨帳號密語歷史等
...
3. **靜音**: 自定禁用一些煩人音效，如彌米倫，武僧職業坐騎
4. **頓號轉斜杠**: 中文輸入法依舊可以進行命令輸入，輸入指令快人一步
5. **關閉特寫**: 強制關閉特寫框架
6. **標籤**: 各職業顏色，目標推測距離，無符號血量，無符號能量，等等
7. **遊戲條**: 添加一個美觀且實用的遊戲條
8. **跳過過場動畫**: 跳過大部分過場動畫; 按下修飾鍵可暫時停用
9. **預組列表**: 美化預組隊伍列表的圖標，並添加一個職業顏色條
10. **移動速度**: 在人物面板顯示移動速度
11. **自動化**: 自動接受復活，召喚及戰鬥中隱藏介面
12. **無漢字計數**: 在數值中使用英文字符來代替漢字
13. **自動擷圖**: 在你獲得成就後自動進行擷圖
