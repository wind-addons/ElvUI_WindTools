...
19. **AdiBags 美化**: 為 AdiBags 添加美化. (需要 AdiBags ElvUI Skin 插件)
20. **Simulationcraft 美化**: 為 Simulationcraft 添加美化.
21. **RaiderIO 美化**: 為 RaiderIO 添加美化.
22. **OmniCC 美化**: 為 OmniCC 的設定, 圖示, 狀態條添加美化.
23. **Auctionator 美化**: 為 Auctionator 的全部框架添加美化.
24. **Postal 美化**: 為 Postal 的常規按鍵及快速附加按鍵添加美化.
