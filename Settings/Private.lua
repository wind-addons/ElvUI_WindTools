	...
	instanceDifficulty = {
		...
		difficulty = {
			...
			customStrings = {
				...
				["Story"] = L["[ABBR] Story"],
				["Heroic"] = hero,
				["Mythic Flexible Raid"] = "%numPlayers%" .. myth,
				["Lorewalking"] = L["[ABBR] Lorewalking"],
				["Decor Duel"] = L["[ABBR] Decor Duel"],
				["World Raid"] = "%numPlayers%" .. L["[ABBR] World Raid"],
				["Naigtal"] = L["[ABBR] Naigtal"],
			},
		},
	},
	superTracker = {
