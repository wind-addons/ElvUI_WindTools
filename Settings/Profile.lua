...
P.unitFrames = {
	...
	nameClip = {
		enable = false,
		player = 0,
		playerTarget = "__Name__",
		pet = 0,
		petTarget = "__Name__",
		target = 0,
		targetTarget = "__Name__",
		targettarget = 0,
		targettargetTarget = "__Name__",
		targettargettarget = 0,
		targettargettargetTarget = "__Name__",
		focus = 0,
		focusTarget = "__Name__",
		focustarget = 0,
		focustargetTarget = "__Name__",
		pettarget = 0,
		pettargetTarget = "__Name__",
		party = 0,
		partyTarget = "__Name__",
		raid1 = 0,
		raid1Target = "__Name__",
		raid2 = 0,
		raid2Target = "__Name__",
		raid3 = 0,
		raid3Target = "__Name__",
		raidpet = 0,
		raidpetTarget = "__Name__",
		arena = 0,
		arenaTarget = "__Name__",
		boss = 0,
		bossTarget = "__Name__",
		tank = 0,
		tankTarget = "__Name__",
		assist = 0,
		assistTarget = "__Name__",
	},
